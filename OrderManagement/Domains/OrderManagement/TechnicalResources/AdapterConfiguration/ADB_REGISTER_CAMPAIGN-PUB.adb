...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ADB_REGISTER_CAMPAIGN-PUB">
        <AESDK:instanceId>ADB_REGISTER_CAMPAIGN-PUB</AESDK:instanceId>
        <AESDK:startup>
        ...
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.VFTR_CAMPAIGN_REQUEST</AESDK:jmsPublisher>
            </AESDK:producers>
        </AESDK:deployment>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/ADB_REGISTER_CAMPAIGN-PUB.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/VFTR_CAMPAIGN_REQUEST</AESDK:resource>
                    <AESDK:children>P_VFTR_CAMPAIGN_REQUEST</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:pollingInterval>%%Domains/OrderManagement/OSM/Operations/RegisterCampaign/Polling/PollingInterval%%</ADB:pollingInterval>
                ...
                <ADB:publishChildData>off</ADB:publishChildData>
                ...
                <ADB:publishingTable>P_VFTR_CAMPAIGN_REQUEST</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ADB_REGISTER_CAMPAIGN-PUB.aeschema#class.P_VFTR_CAMPAIGN_REQUEST</ADB:classReference>
                <ADB:sourceTable>VFTR_CAMPAIGN_REQUEST</ADB:sourceTable>
                <ADB:columnsToPublish>ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>EVENT_SOURCE_TYPE</ADB:columnsToPublish>
                <ADB:columnsToPublish>EVENT_SOURCE</ADB:columnsToPublish>
                <ADB:columnsToPublish>CHANNEL_TYPE</ADB:columnsToPublish>
                <ADB:columnsToPublish>CAMP_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>CAMP_CON_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>RESPONSE_DATE</ADB:columnsToPublish>
                <ADB:columnsToPublish>RESPONSE_TYPE</ADB:columnsToPublish>
                <ADB:columnsToPublish>REJECTION_REASON</ADB:columnsToPublish>
                <ADB:columnsToPublish>KEYWORD</ADB:columnsToPublish>
                <ADB:columnsToPublish>PRODUCT_ID</ADB:columnsToPublish>
                ...
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_VFTR_CAMPAIGN_REQUEST</ADB:name>
                        <ADB:col>ORDER_ID,false,string,VARCHAR2,30,0, ,false,false,false, </ADB:col>
                        <ADB:col>MESSAGE_ID,false,string,VARCHAR2,50,0, ,false,false,false, </ADB:col>
                        <ADB:col>ERROR_CODE,false,string,VARCHAR2,10,0, ,false,false,false, </ADB:col>
                        <ADB:col>ERROR_MESSAGE,false,string,VARCHAR2,50,0, ,false,false,false, </ADB:col>
                        <ADB:userKeys>ID</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>%%Constants/Company%%.%%Constants/ProjectName%%.%%Domains/ServiceCatalog/Name%%.%%Constants/Layer/Technical%%.%%Constants/QOS/Guarantee%%.%%Constants/RequestType/Request%%.ADB_REGISTER_CAMPAIGN-PUB.VFTR_CAMPAIGN_REQUEST</ADB:destination>
                <ADB:endpointReference isRef="true">#jmsProducer.VFTR_CAMPAIGN_REQUEST</ADB:endpointReference>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/Domains/OrderManagement/TechnicalResources/AdapterConfiguration/ADB_REGISTER_CAMPAIGN-PUB.adb#jmsSession.JMSQueue</ADB:sessionReference>
                <ADB:referredObject>VFTR_CAMPAIGN_REQUEST</ADB:referredObject>
        ...
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:useExceptTable>off</ADB:useExceptTable>
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\ADB_REGISTER_CAMPAIGN-PUB.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="VFTR_CAMPAIGN_REQUEST">
        ...
        <AEService:destination>%%Constants/Company%%.%%Constants/ProjectName%%.%%Domains/ServiceCatalog/Name%%.%%Constants/Layer/Technical%%.%%Constants/QOS/Guarantee%%.%%Constants/RequestType/Request%%.ADB_REGISTER_CAMPAIGN-PUB.VFTR_CAMPAIGN_REQUEST</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/ADB_REGISTER_CAMPAIGN-PUB.aeschema#class.P_VFTR_CAMPAIGN_REQUEST</AEService:class>
